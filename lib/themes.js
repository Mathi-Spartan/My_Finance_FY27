...
export const THEMES = [
  ...
  mk('nalam',    'Nalam',        'Night', '#E7F0E9', '#FFFFFF', '#0C1F18', '#4E8C1E', ['#0D3B2E','#12856A','#3DD9A8'],
     { paper:'#0A0F0D', card:'#131A18', ink:'#EAF4F0' }),
  mk('lab',      'The Lab',      'Night', '#F1EAF5', '#FFFFFF', '#1F0C29', '#7A2AA0', ['#3E1152','#7A2AA0','#C77DE8'],
     { paper:'#0D0812', card:'#191022', ink:'#F3EAF8' }),
