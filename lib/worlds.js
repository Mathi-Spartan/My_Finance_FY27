...
export const WORLDS = {
  ...
  health: {
    ...
    name: 'Nalam',
    tamil: 'நலம்',
    tagline: 'What your body has been doing',
    blurb: 'Steps, sleep, heart and weight, synced from Health.',
    palette: 'nalam',
    accent: '#B8F24A',
    g: ['#0D3B2E', '#12856A', '#3DD9A8'],
    tabs: ['today', 'trends', 'body', 'sleep'],
    mode: 'dark',
  },
  lab: {
    id: 'lab',
    ...
    blurb: 'Set a rule, run it for a while, see what actually changed.',
    palette: 'lab',
    accent: '#C77DE8',
...
export const WORLD_LIST = [WORLDS.finance, WORLDS.health, WORLDS.lab];
